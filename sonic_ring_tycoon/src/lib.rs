...
pub const MULTIPLIER_BASE_COST: u64 = 20;
pub const KNUCKLES_BASE_COLLECTION_RATE: u64 = 1;
pub const KNUCKLES_BASE_ADD_COLLECTOR_COST: u64 = 75;
pub const KNUCKLES_BASE_COLLECTION_RATE_UPGRADE_COST: u64 = 150;
pub const CHILI_DOG_BASE_COLLECTION_RATE: u64 = 10;
pub const CHILI_DOG_BASE_ADD_COLLECTOR_COST: u64 = 300;
pub const CHILI_DOG_BASE_COLLECTION_RATE_UPGRADE_COST: u64 = 600;
